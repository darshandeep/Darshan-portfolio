...
const textContainer = document.getElementById("text-container"), words = ["Web designer", "G-designer", "video editor"], typingDelay = 100, erasingDelay = 50, pauseDelay = 1500; let wordIndex = 0, charIndex = 0, isDeleting = !1; 
...
function downloadPDF() {
    ...
    link.href = 'files/Darshan-resume-computer.pdf';
